...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('required_pay', models.FloatField(blank=True, null=True)),
                ('br_state', models.CharField(blank=True, max_length=2, null=True)),
                ('activity', models.CharField(blank=True, max_length=35, null=True)),
