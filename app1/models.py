...
class Freelancers(models.Model):
    ...
    br_state = models.CharField(max_length=2, blank=True, null=True)
...
class Invoices(models.Model):
    ...
    email_freelancer = models.CharField(max_length=50, blank=True, null=True)
    client_name = models.CharField(max_length=50, blank=True, null=True)
    amount = models.FloatField(blank=True, null=True)
    service_desc = models.CharField(max_length=40, blank=True, null=True)
